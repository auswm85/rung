---
title: rung
description: Stacked PRs made simple. A CLI tool for managing stacked pull requests on GitHub and merge requests on GitLab.
template: splash
hero:
...
<CardGrid stagger>
  ...
  <Card title="GitHub & GitLab" icon="github">
    Creates real GitHub pull requests and GitLab merge requests — including
    self-hosted GitLab — with automatic stack navigation comments.
  </Card>
</CardGrid>
